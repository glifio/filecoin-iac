#module "eks_nodegroup_api-read-group9" {
#  count                                   = local.is_dev_envs
#  source                                  = "../modules/nodegroups"
#  get_instance_type                       = "m5d.8xlarge,r5ad.8xlarge"
#  get_nodegroup_name                      = "api-read-group9" # don't need to type ondemand/spot in the name, it will be added automatically.
...
#  http_path                               = "/api-read-group9/lotus/(.*)"
#  service_port                            = 1234
...
#  http_path_ipfs                        = "/api-read-group9/ipfs/4001/(.*)"
...
##  switch_to_another_ingress = true
##  switch_to_token           = data.aws_secretsmanager_secret_version.api_read_dev_lotus
##  switch_to_service         = "api-read-dev-lotus-service"
#
#}