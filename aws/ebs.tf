...
resource "aws_ebs_volume" "fvm_archive_pl_1" {
  ...
  tags = merge(
    {
      "Name"       = "${module.generator.prefix}-fvm-archive-pl-1",
...
resource "aws_ebs_volume" "fvm_archive_pl_2" {
  ...
  tags = merge(
    {
      "Name"       = "${module.generator.prefix}-fvm-archive-pl-2",
      "Tenant"     = "fvm-archive-pl",
      "PartNumber" = 2
    },
    module.generator.common_tags
...
resource "aws_ebs_volume" "fvm_archive_pl_3" {
  ...
  tags = merge(
    {
      "Name"       = "${module.generator.prefix}-fvm-archive-pl-3",
      "Tenant"     = "fvm-archive-pl",
      "PartNumber" = 3
    },
    module.generator.common_tags
...
resource "aws_ebs_volume" "fvm_archive_pl_4" {
  ...
  tags = merge(
    {
      "Name"       = "${module.generator.prefix}-fvm-archive-pl-4",
      "Tenant"     = "fvm-archive-pl",
      "PartNumber" = 4
    },
    module.generator.common_tags
