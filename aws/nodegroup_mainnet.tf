...
module "eks_nodegroup_ondemand_forest_mainnet_0" {
  count  = local.is_prod_envs
  source = "../modules/eks_nodegroup"

  name          = "forest-mainnet-0"
  instance_type = "r6gd.4xlarge"
  ami_type      = "AL2023_ARM_64_STANDARD"
  user_data     = "nvme-spot.sh"
...
module "eks_nodegroup_ondemand_goldsky_forest_mainnet_0" {
  count  = local.is_prod_envs
  source = "../modules/eks_nodegroup"

  name          = "goldsky-forest-mainnet-0"
  instance_type = "r6gd.4xlarge"
  ami_type      = "AL2023_ARM_64_STANDARD"
  user_data     = "nvme-spot.sh"
...
################## Dedicated Hugomrdias Nodegroups #################

module "eks_nodegroup_ondemand_hugomrdias_forest_calibnet_0" {
  count  = local.is_prod_envs
  source = "../modules/eks_nodegroup"

  name          = "hugomrdias-forest-calib-0"
...
#module "eks_nodegroup_ondemand_hugomrdias_forest_calibnet_1" {
#  count  = local.is_prod_envs
#  source = "../modules/eks_nodegroup"
#
#  name          = "hugomrdias-forest-calib-1"
...
module "eks_nodegroup_ondemand_hugomrdias_calib_archive" {
  count  = local.is_prod_envs
  source = "../modules/eks_nodegroup"

  name          = "hugomrdias-calib-archive"
  instance_type = "r6gd.4xlarge"
  ami_type      = "AL2023_ARM_64_STANDARD"
  user_data     = "nvme-spot.sh"
